...
namespace kcp
{
    ...
    public sealed unsafe class Kcp : IDisposable
    {
        ...
        /// </summary>
        public uint DeadLink => _kcp->dead_link;

        /// <summary>
        ///      Whether the connection is dead
        /// </summary>
        public bool IsDeadLink => State == unchecked((uint)-1);
        ...
        ///     Set Dead Link
        /// </summary>
        /// <param name="deadlink">DeadLink</param>
        public void SetDeadLink(uint deadlink)
        {
            _kcp->dead_link = deadlink;
        }
